...
Expression* UnaryOperation::Accept(AstRewriter* w) { return w->Visit(this); }
Expression* CountOperation::Accept(AstRewriter* w) { return w->Visit(this); }
...
VariableProxy::VariableProxy(Zone* zone, Variable* var, int position)
    : Expression(zone, position),
      bit_field_(IsThisField::encode(var->is_this()) |
                 ...
                 DoNotInstrumentField::encode(false)),
...
VariableProxy::VariableProxy(Zone* zone, const AstRawString* name, bool is_this,
    ...
    : Expression(zone, position),
      bit_field_(IsThisField::encode(is_this) | IsAssignedField::encode(false) |
                 IsResolvedField::encode(false) | DoNotInstrumentField::encode(false)),
      variable_feedback_slot_(FeedbackVectorICSlot::Invalid()),
      raw_name_(name),

...
#define DECLARE_FIXED_REWRITE_NODE(type)                \
  ...
  virtual type* Accept(AstRewriter *) FINAL OVERRIDE;   \
...
class TargetCollector FINAL : public AstNode {
 public:
  ...
  virtual TargetCollector* Accept(AstRewriter*) OVERRIDE { UNREACHABLE(); return 0; }
...
class VariableProxy FINAL : public Expression {
 public:
  ...
  bool do_not_instrument() const { return DoNotInstrumentField::decode(bit_field_); }
  void set_do_not_instrument() {
    bit_field_ = DoNotInstrumentField::update(bit_field_, true);
  }
 ...
 protected:
  ...
  class DoNotInstrumentField : public BitField8<bool, 3, 1> {};
...
class ClassLiteral FINAL : public Expression {
 public:
  ...
  DECLARE_FIXED_REWRITE_NODE(ClassLiteral)
...
class SuperReference FINAL : public Expression {
 public:
  ...
  DECLARE_FIXED_REWRITE_NODE(SuperReference)
